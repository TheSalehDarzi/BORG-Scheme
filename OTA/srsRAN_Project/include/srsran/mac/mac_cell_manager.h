...
public:
  ...
  //mirza:start
  virtual void update_bcch_payload(du_cell_index_t cell_index, const byte_buffer& new_sib1_payload){
    fmt::print("update_bcch_payload not implemented for this MAC manager");
  }
  //mirza:end
};
